class Node:
    ...
    def PostOrdertranversal(self,tree):
        res = []
        if tree:
            res.append(tree.data)
            res = res + self.PostOrdertranversal(tree.left)
            res = res + self.PostOrdertranversal(tree.right)
        return res
...
print(tree.PostOrdertranversal(tree))